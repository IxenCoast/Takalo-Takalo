...
create TABLE produit(idp int PRIMARY key AUTO_INCREMENT, nom varchar(255), idu int, idc int ,img varchar(255),title VARCHAR(250) , Description  VARCHAR(250), FOREIGN key (idu) REFERENCES utilisateur(idu), FOREIGN key (idc) REFERENCES categorie(idc));
